...
public class Liri_ideal extends AppCompatActivity {
    ...
    String sizeReallMeat;
    String sizeRalVeget;
    public String getSizeReallMeat() {
        return sizeReallMeat;
    }
    public void setSizeReallMeat(String sizeReallMeat) {
        this.sizeReallMeat = sizeReallMeat;
    }
    public String getSizeRalVeget() {
        return sizeRalVeget;
    }
    public void setSizeRalVeget(String sizeRalVeget) {
        this.sizeRalVeget = sizeRalVeget;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liri_ideal);

        Bundle argumentsRealMeat = getIntent().getExtras();
        assert argumentsRealMeat != null;
        String prob1 = (argumentsRealMeat.get("real_meat")).toString();
        setSizeReallMeat(prob1);

            Bundle argumentsRealVeget = getIntent().getExtras();
            assert argumentsRealVeget != null;
            String prob2 = (argumentsRealVeget.get("real_vegan")).toString();
            setSizeRalVeget(prob2);
    ...
    private void Results(){
        ...
        yes.setVisibility(View.GONE);
        no.setVisibility(View.GONE);
        Intent intentResult = new Intent(this, Resultats.class);


        intentResult.putExtra("real_meat", getSizeReallMeat());
        startActivity(intentResult);

        intentResult.putExtra("real_vegan", getSizeRalVeget());
        startActivity(intentResult);

            String realMeat = String.valueOf(answer_yes.size());
            intentResult.putExtra("ideal_meat", realMeat);
            startActivity(intentResult);

            String realVegan = String.valueOf(answer_no.size());
            intentResult.putExtra("ideal_vegan", realVegan);
            startActivity(intentResult);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent intent = new Intent(Liri_ideal.this, MainActivity.class);
